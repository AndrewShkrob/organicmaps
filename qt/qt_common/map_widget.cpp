...
{
  auto pos = gui::DrapeGui::GetSpeedLimitHelper().GetPosition();
  pos.x += 1;
  gui::DrapeGui::GetSpeedLimitHelper().SetPosition(pos);
  gui::DrapeGui::GetSpeedLimitHelper().SetRadius(gui::DrapeGui::GetSpeedLimitHelper().GetRadius() + 1.0f);
